      ...
      <div className="max-w-[800px] mx-auto px-6 py-12 space-y-20">
        ...
        <section className="space-y-8">
          ...
          <div className="flex overflow-x-auto gap-4 py-2 pb-8 snap-x no-scrollbar -mx-6 px-6">
            {pets.map((pet) => (
              <div key={pet.id} onClick={() => setSelectedPetId(pet.id)} className={`group shrink-0 w-[120px] snap-start space-y-2 cursor-pointer p-2 rounded-2xl transition-all ${selectedPetId === pet.id ? 'bg-zinc-50 ring-1 ring-black ring-offset-2' : 'hover:bg-zinc-50'}`}>
              ...
              {editingActivity.type === '밥 먹이기' ? (
                ...
                <div className="space-y-4">
                  ...
                  <input
                    autoFocus
                    type="text"
                    className="w-full text-lg border-b border-zinc-100 focus:border-black focus:ring-0 py-4"
                    value={editDetails}
