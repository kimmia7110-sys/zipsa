    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-zinc-100 z-[100] pb-safe shadow-[0_-5px_20px_rgba(0,0,0,0.03)]">
        <nav className="max-w-[800px] mx-auto px-6 py-2 flex justify-between items-center">
          <button onClick={() => { setActiveBottomTab('home'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className={`flex flex-col items-center gap-1.5 transition-colors flex-1 py-1 sm:py-2 ${activeBottomTab === 'home' ? 'text-black' : 'text-[#888888] hover:text-zinc-600'}`}>
          ...
          <button onClick={() => { setActiveBottomTab('pocket'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className={`flex flex-col items-center gap-1.5 transition-colors flex-1 py-1 sm:py-2 ${activeBottomTab === 'pocket' ? 'text-black' : 'text-[#888888] hover:text-zinc-600'}`}>
          ...
          <button onClick={() => { setActiveBottomTab('calendar'); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className={`flex flex-col items-center gap-1.5 transition-colors flex-1 py-1 sm:py-2 ${activeBottomTab === 'calendar' ? 'text-black' : 'text-[#888888] hover:text-zinc-600'}`}>
